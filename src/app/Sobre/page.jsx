...
import PessoasComendoSorvete from "../../../public/sobre-image.jpg";
        ...
        <>
            <main className={estilos.container_principal}>
                ...
                <section className={estilos.secao_imagens}>
                    <div>
                        <Image className={estilos.img} src={PessoasComendoSorvete} alt="pessoas comendo sorvete" />
                        <Image className={estilos.img} src={Loja} alt="loja sorveteria" />
                    </div>
                </section>
            </main>
        </>
